(() => {
  ...
  // extensions/upsell-extension/src/Checkout.jsx
...
${errorInfo.componentStack}`);
  ...
  var variantId = "gid://shopify/ProductVariant/44686337507566";
  function Extension() {
    var _a;
    const { query } = useApi();
    ...
    const [variantData, setVariantData] = (0, import_react17.useState)({
      title: "",
      price: {
        amount: "",
        currencyCode: ""
    ...
    const cartLineId = (_a = lines.find(
        ...
        InlineLayout2,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { spacing: "none", children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { size: "medium", emphasis: "strong", children: variantData.product.title }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { appearance: "subdued", children: variantData.price.amount })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              Button2,
              {
...
//# sourceMappingURL=upsell-extension.js.map
